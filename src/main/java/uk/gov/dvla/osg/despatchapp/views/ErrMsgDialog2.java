...
public class ErrMsgDialog2 {

    final String code, message, action;

    private ErrMsgDialog2(Builder builder) {
    ...
    /**
     * Creates builder to build {@link ErrMsgDialog2}.
    ...
    /**
     * Builder to build {@link ErrMsgDialog2}.
     */
    public static final class Builder {
        ...
        public void display() {
            new ErrMsgDialog2(this).display();;
        }
    }
}
